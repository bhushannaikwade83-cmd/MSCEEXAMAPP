...
class WebPinSetupScreen extends StatefulWidget {
  const WebPinSetupScreen({
    super.key,
  ...
  @override
  State<WebPinSetupScreen> createState() => _WebPinSetupScreenState();
}

class _WebPinSetupScreenState extends State<WebPinSetupScreen> {
